...
{   
	...
	if(!PORTAbits.RA3)	//This example uses the sw2 I/O pin to determine if the device should enter the bootloader, or the main application code
	{
    InitializeSystem();
    while(1)
    {
